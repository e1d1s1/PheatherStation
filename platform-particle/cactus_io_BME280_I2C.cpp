/***************************************************************************
 ...
 It supports up to 2 BME280MESSAGE: Entering directory `/home/eric/src/PheatherStation/build.codelite'
/bin/sh -c '/usr/bin/make -j 6'
----------Building project:[ PheatherStaton - NoConfig ]----------
fatal: No names found, cannot describe anything.
fatal: No names found, cannot describe anything.
-- New changeset was pushed, updating changeset information in the pheatherstation binary.
[  0%] Built target changeset
[100%] Built target pheatherstation-core
make[3]: warning: jobserver unavailable: using -j1.  Add '+' to parent make rule.
/home/eric/src/PheatherStation/platform-particle/main.cpp: In function 'void loop()':
 sensors connected on the I2C bus
...
bool BME280_I2C::begin(uint8_t id) {
    
    Wire.begin();
    
    id = read8(BME280_REGISTER_CHIPID) ;
    if (id != 0x60)
